        ...
        <div class="row">
           <div class="col-sm-2" id="toolBar">
                ...
                <div class="container" id = "searchBar">
                    ...
                    <br>
                    <img src="../images/search.png" alt="logo" id="searchIcon">
                    <form name="searchTopic" action="../PHP/searchedTopic.php" " method="post" novalidate>
                    <input type="text" id="searchInput" placeholder="Search" name="search"/>
                    <input type="submit" value="Submit" name="search" class="logInbtn"></input>
                </form>
                </div>
            ...
            <h3 id ="yourPosts"> Related Posts </h3>
             ...
             if($error != null)
             {
               ...
               exit($output);
                 ...
                 $sql = "SELECT title, body, date FROM posts WHERE title LIKE '%$searchedTopic%'";
